...
subprocess.call('cd /home/pi/Public/NodeJS-Server | sudo pm2 start bin/www', shell=True)
subprocess.call('cd /home/pi/Public/NodeJS-Server | sudo pm2 start request.js', shell=True)
