...
subprocess.call('mkdir /Public/NodeJS-Server | git clone git://github.com/maodijim/NodeJS-Server /Public/NodeJS-Server', shell=True)

print ('\nInstalling PM2\n')
subprocess.call('sudo npm install pm2 -g', shell=True)
subprocess.call('sudo pm2 startup', shell=True)
subprocess.call('sudo pm2 start /home/pi/Public/NodeJS-Server/bin/www', shell=True)
subprocess.call('sudo pm2 start /home/pi/Public/NodeJS-Server/request.js', shell=True)
