...
subprocess.call('cd /home/pi/Public/NoJS-Server | sudo pm2 start bin/www', shell=True)
subprocess.call('cd /home/pi/Public/NoJS-Server | sudo pm2 start request.js', shell=True)
